      ...
      <div className='mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='relative z-10 mx-auto max-w-prose text-base lg:mx-0 lg:max-w-5xl lg:pr-72'>
          <p className='text-lg text-gray-500'>
            Information plays an essential role in making the wold a better
            place. Blocking free flow of information hurts this process, as well
            as buisinesses and people in myriad ways. Even worse, it is also
            being used to neutralise movements and protests of suppressed
            citizens.
          </p>
        </div>
